...
export default function Login() {
    ...
    // console.log(VITE_GOOGLE_CLIENT_ID, VITE_GOOGLE_CLIENT_SECRET)
...
//   };
    ...
    <div>
        ...
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 shadow-lg dark:text-gray-100">
	<h1 className="text-2xl font-bold text-center">Login</h1>
	<form  action="" className="space-y-6">
		<div className="space-y-1 text-sm">
			<label htmlFor="username" className="block dark:text-gray-400 pb-2">Username</label>
			<input type="text" name="username" id="username" placeholder="Username" className="w-full px-4 py-3 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
		</div>
		<div className="space-y-1 text-sm">
